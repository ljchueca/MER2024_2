...
setwd("/Users/ljchueca/Documents/_Trabajos_departamento/2023_MER_Master_Course/Anchovy_data_ADMIXTURE")

# read bamlist used with ANGSD
bams <- read.table("bamlist.bin")[,1]
...
multiplot(p2 + scale_fill_manual(values = c("#F0E442", "#56B4E9")),
          p3 + scale_fill_manual(values = c("#F0E442", "#009E73", "#56B4E9")),
          p4 + scale_fill_manual(values = c("#F0E442", "#009E73", "#CC79A7", "#56B4E9")),
          p5 + scale_fill_manual(values = c("#009E73", "#56B4E9", "#E69F00", "#CC79A7", "#F0E442")),
          p6 + scale_fill_manual(values = c("#CC79A7", "#E69F00", "#009E73", "#006046", "#56B4E9", "#F0E442")),
          p7 + scale_fill_manual(values = c("#E69F00", "#F0E442", "#CC79A7", "#009E73", "#56B4E9", "#D55E00", "#006046")),
          p8 + scale_fill_manual(values = c("#006046", "#F0E442", "#D55E00", "#009E73", "#CC79A7", "#56B4E9", "#E69F00", "#0072B2")),
          p9 + scale_fill_manual(values = c("#56B4E9", "#0072B2", "#E69F00", "#CC79A7", "#666666", "#006046", "#009E73", "#F0E442", "#D55E00")),
          p1 + scale_fill_manual(values = c("#56B4E9", "#006046", "#009E73", "#0072B2", "#D55E00", "#E69F00", "#873b00", "#666666", "#CC79A7", "#F0E442")) +
          # fix y label
          ylab("K = 10")
          )
